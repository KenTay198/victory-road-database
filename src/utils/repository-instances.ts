...
export const characterServiceInstance = getCharacterServiceInstance();
export const metaServiceInstance = getMetaServiceInstance();
export const hissatsuServiceInstance = getHissatsuServiceInstance();
export const settingsServiceInstance = getSettingsServiceInstance();
